...
import { CalendarIcon, Lightbulb, Loader2, Search } from 'lucide-react';
...
export function TimelineEntryForm({ onAddEntry, pastEntries }: TimelineEntryFormProps) {
  ...
  const handleSuggestionFetch = useCallback(async (fieldType: 'docket' | 'description', currentValue: string) => {
    if (!currentValue.trim() || currentValue.length < 3) { // Only fetch if some input
  ...
  return (
    <Card className="shadow-lg">
      <CardHeader>
        <CardTitle className="text-2xl font-semibold text-foreground">Add New Timeline Entry</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="relative">
            ...
            <div className="relative mt-1">
              <Input
                ...
                onBlur={() => setTimeout(() => setShowDocketSuggestions(false), 100)} // Delay to allow click on suggestion
              />
          ...
          <div className="relative">
            ...
            <Textarea
              ...
              onBlur={() => setTimeout(() => setShowDescriptionSuggestions(false), 100)} // Delay to allow click
            />
          ...
          <div>
            ...
            <Input
              id="timeSpent"
              type="text" // Changed from time to text to allow custom format enforcement
